...
session_start(); //创建Session对象
$_SESSION["test"]=$test; //保存简单的test数据
unset($_SESSION['test']); //销毁一个变量
session_unset();session_destroy(); //销毁Session对象
session.gc_maxlifetime=9999; //设置Session对象有效时间
